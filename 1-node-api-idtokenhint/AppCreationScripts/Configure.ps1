...
{
    $lines = Get-Content $configFilePath -Raw
...
#> 
   ...
   Write-Host "Creating the AAD application (Verifiable Credentials Node sample)"
   # Get a 2 years application key for the client Application
   $pw = ComputePassword
   $fromDate = [DateTime]::Now;
   $key = CreateAppKey -fromDate $fromDate -durationInYears 2 -pw $pw
   $clientAppKey = $pw
   $clientAadApplication = New-AzureADApplication -DisplayName "Verifiable Credentials Node sample" `
                                                  -IdentifierUris "https://$tenantName/vcnodesample1" `
   ...
   Write-Host "Done creating the client application (VC Node sample)"

   # URL of the AAD application in the Azure portal
   # Future? $clientPortalUrl = "https://portal.azure.com/#@"+$tenantName+"/blade/Microsoft_AAD_RegisteredApps/ApplicationMenuBlade/Overview/appId/"+$clientAadApplication.AppId+"/objectId/"+$clientAadApplication.ObjectId+"/isMSAApp/"
   $clientPortalUrl = "https://portal.azure.com/#blade/Microsoft_AAD_RegisteredApps/ApplicationMenuBlade/CallAnAPI/appId/"+$clientAadApplication.AppId+"/objectId/"+$clientAadApplication.ObjectId+"/isMSAApp/"
   Add-Content -Value "<tr><td>client</td><td>$currentAppId</td><td><a href='$clientPortalUrl'>VC Node sample</a></td></tr>" -Path createdApps.html
   ...
   $dictionary = @{ "<YOUR-AAD-TENANDID>" =  $tenantId; "<YOUR-AAD-CLIENTID-FOR-KEYVAULT-ACCESS>" = $clientAadApplication.AppId; "<YOUR-AAD-CLIENTSECRET-FOR-KEYVAULT-ACCESS>" = $clientAppKey };
